...
6. IMPORTANT ADDITION: You must create and initialize the MySQL database
    ...
    - Second, create a file named `.env` within the `REVyourSTARTUP` directory. This file will contain the appropraite environment variables required for Django to connect to the database. THIS FILE IS PART OF `.gitignore`, and as such it is important that you set it up correctly. 
    - Here are the contents of the file: `SECRET_KEY=django-insecure-)qg200wnf_rtwaw#7lkh9eg6j4j--_gj1rbsin*$^%o6356h#*
